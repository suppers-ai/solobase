...
const SIGN_IN_URL = 'https://cloud.solobase.dev/blocks/dashboard/frontend/';
  ...
  return (
    <section style={{ background: '#f9fafb', padding: '4rem 1.5rem' }}>
      <div class="max-w-5xl mx-auto">
        <h2 class="text-3xl font-bold text-center text-gray-900 mb-3">Platform Agnostic by Design</h2>
        <p class="text-center text-gray-600 mb-10 max-w-2xl mx-auto">
          Build once, deploy anywhere. No vendor lock-in, no rewriting code when your infrastructure changes.
        </p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          {items.map((item) => (
            <div key={item.title} class="bg-white rounded-xl p-6" style={{ border: '1px solid #e5e7eb' }}>
              <div class="mb-3" style={{ color: '#fe6627' }}>{item.icon}</div>
...
function AgentReady() {
  ...
  return (
    <section style={{ background: '#ffffff', padding: '4rem 1.5rem' }}>
      <div class="max-w-5xl mx-auto">
        <h2 class="text-3xl font-bold text-center text-gray-900 mb-3">Built for AI Agents</h2>
        <p class="text-center text-gray-600 mb-10 max-w-2xl mx-auto">
          AI agents need backends too. Solobase gives them a complete, API-driven infrastructure they can provision and use autonomously.
        </p>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {points.map((item) => (
            <div key={item.title} class="rounded-xl p-6" style={{ border: '1px solid #e5e7eb' }}>
              <div class="mb-3" style={{ color: '#fe6627' }}>{item.icon}</div>
              <h3 class="font-semibold text-gray-900 mb-1">{item.title}</h3>
              <p class="text-sm text-gray-600 leading-relaxed">{item.desc}</p>
            </div>
