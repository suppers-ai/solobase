<script lang="ts">
	...
	export let microsoftClientId: string = '';
	export let facebookClientId: string = '';
...
<div class="login-page">
	<div class="login-container">
		...
		<!-- OAuth Login Section (Now on Top) -->
		{#if showOAuthButtons && availableProviders.length > 0}
			<div class="oauth-buttons">
				...
				{#if availableProviders.includes('microsoft')}
					<button
						type="button"
