...
# Solobase
SUPPERS_AI__PRODUCTS__STRIPE_SECRET_KEY=sk_test_mock \
SUPPERS_AI__PRODUCTS__STRIPE_WEBHOOK_SECRET=whsec_test_mock_secret_for_e2e \
SUPPERS_AI__PRODUCTS__STRIPE_API_URL=http://127.0.0.1:12111 \
ALLOW_PRIVATE_NETWORK=true \
SUPPERS_AI__AUTH__JWT_SECRET=test-secret-key-for-e2e \
SUPPERS_AI__AUTH__ADMIN_EMAIL=admin@e2e.test \
SUPPERS_AI__AUTH__ADMIN_PASSWORD=AdminE2EPass1234 \
SOLOBASE_SHARED__RATE_LIMIT_AUTH=0 \
SOLOBASE_SHARED__RATE_LIMIT_API_READ=0 \
SOLOBASE_SHARED__RATE_LIMIT_API_WRITE=0 \
SOLOBASE_SHARED__RATE_LIMIT_IP=0 \
RUST_LOG=warn \
