...
# ── Config ──────────────────────────────────────────────────────────
SUPPERS_AI__AUTH__ADMIN_EMAIL="${SUPPERS_AI__AUTH__ADMIN_EMAIL:-admin@example.com}"
SUPPERS_AI__AUTH__ADMIN_PASSWORD="${SUPPERS_AI__AUTH__ADMIN_PASSWORD:-admin123}"
...
export SUPPERS_AI__PRODUCTS__STRIPE_SECRET_KEY=sk_test_mock
export SUPPERS_AI__PRODUCTS__STRIPE_WEBHOOK_SECRET=whsec_test_mock_secret_for_e2e
export SUPPERS_AI__PRODUCTS__STRIPE_API_URL=http://127.0.0.1:${STRIPE_MOCK_PORT}
export ALLOW_PRIVATE_NETWORK=true
export SUPPERS_AI__AUTH__JWT_SECRET
export SUPPERS_AI__AUTH__ADMIN_EMAIL
