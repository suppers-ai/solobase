...
type Purchase struct {
	...
	StripeConnectAccountID string `json:"stripeConnectAccountId,omitempty"` // Connected account ID for seller
	PlatformFeeCents       int64  `json:"platformFeeCents,omitempty"`       // Platform fee in cents
}
